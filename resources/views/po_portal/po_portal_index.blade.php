...
<script src="<?= env('APP_ASSET') ?>assets/js/jquery/jquery.min.js"></script> 
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post"> 
        <div id="kt_content_container" class="container-xxl">  
                ...
                <div class="card-header border-0 pt-6"> 
                    <div class="card-title"> 
                        <div class="d-flex align-items-center position-relative my-1"> 
                            ...
                            <input type="text" data-kt-goodreceive-table-filter="search" id="front_table_search" class="form-control form-control-solid w-250px ps-15" placeholder="Search PO Number" />
                        </div> 
                    </div> 
                ...
                <div class="card-body pt-0"> 
                    <table class="table align-middle table-row-dashed table-striped fs-6 gy-5 no-footer" id="kt_doc_table">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Desrcription</th>  
...
<script>
    ...
    $(document).ready(function () {
        var frontTable = $("#kt_doc_table").DataTable({
            ...
            ajax: {
                url: "{{ route('po_portal.front_table') }}",
                type: 'POST',
...
function document_preview(trc_unix_id, ref_form) 
    {     
        ...
        $("#file_view").html("");    
            ...
            $.ajax({
                type	: 'POST',
                url	: "{{ route('po_portal.print_view') }}",
                data	: string,
                cache	: false,
