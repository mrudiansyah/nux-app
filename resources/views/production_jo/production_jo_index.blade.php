...
@section('subcontent')     
    ...
    <div class="d-flex flex-column flex-root"> 
        <div class="d-flex flex-column flex-column-fluid">
            <div class="d-flex flex-column flex-column-fluid text-center py-lg-10"> 
                <div class="pt-lg-10 mb-10"> 
                    <h1 class="fw-bolder fs-2qx text-gray-800 mb-10">Comming Soon!</h1>   
                </div> 
                <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px" 
                style="background-image: url(<?= env('APP_ASSETS') ?>assets/media/illustrations/sketchy-1/17.png"></div>
            </div>  
        </div> 
    </div> 
@endsection