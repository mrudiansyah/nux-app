...
@section('subcontent')   
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">  
                                        ...
                                        <form>
                                            <div> 
                                                <div class="form-group mb-3">
                                                    <label class="mb-2 text-sm">Date <span class="text-danger">*</span></label>
                                                    <input type="date" class="form-control bg-light-primary" id="SearchCreatedAt" name="SearchCreatedAt" value="<?php date_default_timezone_set('Asia/Jakarta'); echo date('Y-m-d');  ?>"/> 
                                                </div>  
                                            </div> 
                                        </form> 
                                    </div>
                                        ...
                                        <form>
                                            <div>  
                                                <div class="form-group mb-3"> 
                                                    ...
                                                    <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="false" id="SearchToWarehouseID" name="SearchToWarehouseID" data-hide-search="false"/>  
                                ...
                                <div class="card-header border-1 pt-6 pb-6 mb-5"> 
                                    <div class="card-title"> 
                                        <div class="d-flex align-items-center position-relative my-1"> 
                                            ...
                                            <input type="text" data-kt-goodreceive-table-filter="search" id="front_table_search" class="form-control form-control-solid w-250px ps-15 text-sm form-control-sm" placeholder="Search ID/Warehouse" />
                                        </div> 
                                    </div>  
     ...
     <script>   
        ...
        function open_document(DocNum, no) {
            ...
            $.ajax({
                type	: 'POST',
                url	: "{{ route('inventory_move_in.add_document') }}",
                data	: string,
                cache	: false, 
...
<script>    
    function front_table() {  
        var frontTable = $("#kt_doc_table").DataTable({
            ...
            ajax: {
                url: "{{ route('inventory_move_in.front_table') }}",
                type: 'POST',
                data: function (d) { 
                    d._token = $("[name=_token]").val(); 
                    d.ToWarehouseID = $("#SearchToWarehouseID").val(); 
