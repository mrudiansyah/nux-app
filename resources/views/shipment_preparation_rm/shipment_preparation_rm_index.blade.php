...
@section('subcontent')
    ...
    <script>
        ...
        function ready_to_print() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation_rm.ready_to_print') }}",
                data: string,
                cache: false,
                dataType: 'json',
        ...
        function un_ready_to_print() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation_rm.un_ready_to_print') }}",
                data: string,
                cache: false,
                dataType: 'json',
                success: function(data) {
        ...
        function delete_lot(packNum, packLine, sysID) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation_rm.check_before_delete') }}",
                data: string,
                cache: false,
                dataType: 'json',
                success: function(data) {
        ...
        function getCountDocument() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation_rm.get_count_document') }}",
                data: string,
                cache: false,
                dataType: 'json',
                success: function(data) {
        ...
        function front_table() {
            var frontTable = $("#kt_doc_table").DataTable({
                ...
                ajax: {
                    url: "{{ route('shipment_preparation_rm.front_table') }}",
                    type: 'POST',
                    data: function(d) {
        ...
        function delete_document(trc_unix_id) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation_rm.delete_document') }}",
                data: string,
                cache: false,
                dataType: 'json',
                success: function(data) {
        ...
        function backHome() {
            ...
            $("#temp_id").val('');
            refresh_front_table();
            window.history.pushState('', '', '<?php echo env('BASE_URL'); ?>/shipment_preparation_rm');
        }
        ...
        function detail_release_table() {
            var detailReleaseTable = $("#kt_doc_table_3").DataTable({
                ...
                ajax: {
                    url: "{{ route('shipment_preparation_rm.detail_release_table') }}",
                    type: 'POST',
                    data: function(d) {
        ...
        function detail_table() {
            var detailTable = $("#kt_doc_table_2").DataTable({
                ...
                ajax: {
                    url: "{{ route('shipment_preparation_rm.detail_table') }}",
                    type: 'POST',
                    data: function(d) {
        ...
        function getPreview() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation_rm.get_preview_doc') }}",
                data: string,
                cache: false,
                dataType: 'json',
                success: function(data) {
                    window.history.pushState('', '', '<?php echo env('BASE_URL'); ?>/shipment_preparation_rm?ref_doc=' +
        ...
        function add_document() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation_rm.add_document') }}",
                data: string,
                cache: false,
                dataType: 'json',
                success: function(data) {
        ...
        function set_order_number() {
            ...
            if (OrderNum != OrderNumSet) {
                ...
                if (confirm(text) == true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('shipment_preparation_rm.set_order_number') }}",
                        data: string,
                        cache: false,
                        dataType: 'json',
                        success: function(data) {
                ...
                success: function(data) {
                    ...
                    setTimeout(function() {
                        ...
                        window.history.pushState('', '',
                            '<?php echo env('BASE_URL'); ?>/shipment_preparation_rm?ref_doc=' + trc_unix_id +
        ...
        function submit_label() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation_rm.submit_label') }}",
                data: string,
                dataType: 'json',
                cache: false,
                success: function(data) {
                    ...
                    if (data.process_status == 1) {
                        if (data.ready_to_post == 1) {
                            post_detail(OrderNum, data.order_line, data.order_rel, data.part_num, data
                                .part_name, labelQty, data.po_num, ext_label, data.lot_num,data.warehouseCode,data.WarehouseDesc);
                        } else {
                            Toast.fire({
                                position: 'bottom-end',
                                title: "Silahkan scan label customer!",
...
let unloadHandler = function (e) {
  ...
  e.returnValue = '';
        ...
        function submit_label_by_slip_no() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation_rm.submit_label_by_slip_no') }}",
                data: string,
                dataType: 'json',
                cache: false,
                success: function(data) {
        ...
        function post_detail(OrderNum, order_line, order_rel, part_num, part_name, labelQty, po_num, ext_label, lot_num,warehouseCode,warehouseDesc) {
            var button = document.getElementById('btn_submit_label');
            var spinner = document.getElementById('spinner');
            var buttonText = document.getElementById('btn_text');
            ...
            var token = $("[name=_token]").val();
            $.ajax({
                url: "{{ route('shipment_preparation_rm.post_detail') }}",
                type: 'POST',
                data: "_token=" + token + "&trc_unix_id=" + trc_unix_id + "&orderNum=" + OrderNum + "&orderLine=" +
                    ...
                    lot_num + "&warehouseCode=" + warehouseCode+"&warehouseDesc=" + warehouseDesc,
                cache: false,
                success: function(data) {
                    if (data.code == 200) {
                        Toast.fire({
