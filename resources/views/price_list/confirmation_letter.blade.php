...
<body>
    ...
    <table width="100%">
        <tr>
            <td class="right">
                Karawang, {{ \Carbon\Carbon::parse($data->CreatedAt)->format('d F Y') }}
            </td>
        </tr>
    </table>
    ...
    <br>
    @php
        $date = \Carbon\Carbon::parse($data->CreatedAt);
        $romawi = [
            1 => 'I',
            2 => 'II',
            3 => 'III',
    ...
    <table width="100%">
        <tr>
            ...
            <td width="85%">:{{ $data->ID }}/PC-SAI/{{ $romawi[$date->month] }}/{{ $date->year }}</td>
        </tr>
        <tr>
            <td>Subject</td>
    ...
    <table width="100%">
        ...
        <tr>
            <td>With reference to your price confirmation of Purchase Raw material, here with we would like to confirm
