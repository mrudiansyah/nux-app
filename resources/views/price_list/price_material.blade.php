    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td width="33%" valign="middle" align="center">
                <span class="bold">Price Material {{ $header->Description }}</span>
            </td>
            <td width="34%" valign="top">
                <table width="100%" cellpadding="0">
                    ...
                    <tr>
                        <td>Issue Date</td>
                        <td>:</td>
                        <td>{{ \Carbon\Carbon::parse($header->CreatedAt)->format('d F Y') }}</td>
                    </tr>
                    <tr>
                        <td>Prepared By</td>
                        <td>:</td>
                        <td>{{ $header->CreatedByName }}</td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <tr>
                ...
                <td>
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="left">Rp</td>
                            <td align="right">{{ number_format($item->PriceKg, 0, ',', '.') }}</td>
                        </tr>
                    </table>
                </td>
                ...
                <td>
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="left">Rp</td>
                            <td align="right">{{ number_format($item->PriceSheet, 0, ',', '.') }}</td>
                        </tr>
                    </table>
                </td>

                <td align="center">{{ number_format($item->UnitWeight, 0, ',', '.') }}</td>
            </tr>
        @endforeach
    </table>
    <br><br>
    ...
    <table width="100%" cellpadding="2">
        <tr>
            ...
            <td width="48%" valign="top">
                ...
                - The prices listed are the prices for the {{ \Carbon\Carbon::parse($header->StartDate)->format('F') }}
                - {{ \Carbon\Carbon::parse($header->EndDate)->format('F Y') }} period
            </td>
            ...
            <td width="52%" valign="top">
                <table width="100%" cellpadding="3">
                    ...
                    <!-- NAMA -->
                    <tr>
                        <td align="center" style="border: 1px solid black">{{ $header->CreatedByName }}</td>
