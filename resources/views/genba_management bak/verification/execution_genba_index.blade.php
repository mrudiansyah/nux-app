                                                ...
                                                <div class="px-7 py-5">
                                                    <div class="mb-5">
                                                        ...
                                                        <select class="form-select form-select-solid fw-bolder"
                                                            ...
                                                            data-allow-clear="false" id="status_table"
                                                            data-hide-search="true">
                                                            <option value=""></option>
                                                            <option value='SPV'>SPV Genba</option>
                                                            <option value='Manager'>Manager Genba</option>
                                                        </select>
                                                    </div> --}}
                                                    <div class="d-flex justify-content-end">
                                                        <button type="submit" id="submit-filter" class="btn btn-primary"
                                                            data-kt-menu-dismiss="true"
                                                            data-kt-goodreceive-table-filter="filter" hidden>Apply</button>
                                                    </div>
                                                    {{--
                                                </div>
                                            </div>
